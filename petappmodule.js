...
const addPet = (pet) => {
    ...
    <button type="button" class="btn btn-primary" onclick="openPetDetail(${pet.id})">Details</button>
    <button type="button" class="btn btn-danger"  onclick="removePet(${pet.id})">Delete</button>
  </div>
                </div>
`;
